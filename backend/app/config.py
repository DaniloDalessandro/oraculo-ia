...
class Settings(BaseSettings):
    ...
    DATABASE_URL_SYNC: str = "postgresql+psycopg2://postgres:postgres@db:5432/oraculo"  # URL síncrona usada pelos workers Celery (psycopg2 via asyncpg não funciona em workers sync)
    ...
    AI_PROVIDER: str = "groq"  # provedor: "groq", "gemini" ou "openai"
